...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="mb-3">
                <label for="" class="control-label">Número de referencia de orden:</label>
...
<div class="py-1 text-right">
    <button class="btn btn-sm btn-light bg-gradient-light border btn-flat" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Cerrar</button>
</div>