  ...
  <div class="container px-4 px-lg-5 ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex align-items-center">
        <?php if ($_settings->userdata('id') != '' && $_settings->userdata('login_type') == 2) : ?>
          <div class="btn-group nav-link">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <a class="dropdown-item" href="<?php echo base_url . '?p=orders' ?>"><span class="fa fa-table"></span> Mis Órdenes</a>
              <div class="dropdown-divider"></div>
        ...
        <?php else : ?>
          <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./login.php">Ingresar</a>
          <a class="font-weight-bolder text-light mx-2 text-decoration-none" href="./register.php">Regístrate</a>
