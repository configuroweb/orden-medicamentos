...
<div class="container-fluid">
    <form action="" id="stock-form">
        ...
        <div class="form-group">
            <label for="expiration" class="control-label">Fecha de Expiración</label>
            ...
            <small class="text-muted"><i>Borra la fecha de vencimiento si el producto no tiene vencimiento.</i></small>
        </div>
    </form>
</div>
<script>
    $(function() {
        $('#stock-form').submit(function(e) {
            ...
            $('.err-msg').remove();
            var el = $('<div>')
            el.addClass("alert alert-dark err-msg")
            el.hide()
            start_loader();
            $.ajax({
