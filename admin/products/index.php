...
<div class="card card-outline rounded-0 card-dark">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="./?page=products/manage_product" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Crear Nuevo</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("¿Está seguro de eliminar este producto de forma permanente?", "delete_product", [$(this).attr('data-id')])
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
