...
<div class="content py-5 px-3 bg-gradient-dark">
	<h2><b><?= isset($id) ? "Actualizar detalles del producto" : "Entrada de nuevos productos" ?></b></h2>
</div>
	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				<button class="btn btn-primary btn-sm bg-gradient-primary btn-flat" form="product-form"><i class="fa fa-save"></i> Guardar</button>
...
<script>
	...
	$(document).ready(function() {
		$('#category_id').select2({
			placeholder: "Seleccione la categoría aquí",
			width: '100%',
