	...
	<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
		<div class="card rounded-0">
			...
			<div class="card-footer py-1 text-center">
				...
				<a class="btn btn-primary btn-sm bg-gradient-primary rounded-0" href="./?page=products/manage_product&id=<?= isset($id) ? $id : '' ?>"><i class="fa fa-edit"></i> Editar</a>
				<a class="btn btn-light btn-sm bg-gradient-light border rounded-0" href="./?page=products"><i class="fa fa-angle-left"></i> Volver</a>
			</div>
		</div>
	</div>
</div>
<script>
	$(function() {
		$('#delete_data').click(function() {
			_conf("Deseas eliminar este producto?", "delete_product", ["<?= isset($id) ? $id : '' ?>"])
		})
	})
