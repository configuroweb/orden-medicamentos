	...
	<div class="card card-outline rounded-0 card-dark">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="" class="control-label">Contenido de Bienvenida</label>
				...
				?>
						<div class="d-flex w-100 align-items-center img-item">
							...
							<span class="ml-4"><button class="btn btn-sm btn-default text-dark rem_img" type="button" data-path="<?php echo base_app . $upload_path . '/' . $img ?>"><i class="fa fa-trash"></i></button></span>
						</div>
					<?php endforeach; ?>
				<?php endif; ?>
			</form>
