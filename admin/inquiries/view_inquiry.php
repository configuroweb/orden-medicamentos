...
<div class="content bg-gradient-primary py-5 px-4">
    <h3 class="font-weight-bolder">Información de Consulta</h3>
</div>
    ...
    <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
        <div class="card card-outline card-primary rounded-0 shadow">
                    ...
                    <fieldset>
                        <div class="row mb-3">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <label for="" class="control-label text-muted">Nombre de Quien Consulta</label>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for="" class="control-label text-muted">Mensaje</label>
            ...
            <div class="card-footer py-1 text-center">
                <button id="delete_inquiry" class="btn btn-dark btn-flat bg-gradient-dark btn-sm" type="button"><i class="fa fa-trash"></i> Eliminar</button>
                <a class="btn btn-light btn-flat bg-gradient-light border btn-sm" href="./?page=inquiries"><i class="fa fa-angle-left"></i> Volver</a>
            </div>
        </div>
    </div>
</div>
<script>
    $(function() {
        $('#delete_inquiry').click(function() {
            _conf("¿Deseas eliminar esta consulta de forma permanente?", "delete_inquiry", ['<?= isset($id) ? $id : '' ?>'])
        })
    })
