...
class Users extends DBConnection
{
	...
	function registration()
	{
		...
		if ($save) {
			...
			$resp['uid'] = $uid;
			if (!empty($id))
				$resp['msg'] = 'Los detalles del usuario se han actualizado con éxito';
			else
				$resp['msg'] = 'Su cuenta ha sido creada con éxito';
	...
	public function delete_customer()
	{
		...
		if ($qry) {
			$this->settings->set_flashdata('success', 'Los detalles del cliente se han eliminado correctamente.');
			$resp['status'] = 'success';
