...
<section class="py-3">
    <div class="container">
        <div class="content px-3 py-5 bg-gradient-maroon">
            <h3 class=""><b>Carrito de Compras</b></h3>
        </div>
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                                            ...
                                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                                <div style="line-heigth:1em">
                                                    ...
                                                    <div class="text-muted d-flex w-100">
                                                        ...
                                                        <div class="col-auto">
                                                            <button class="btn btn-sm btn-flat btn-dark del-item" type="button"><i class="fa fa-trash"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <?php if ($cart->num_rows <= 0) : ?>
                                <h5 class="text-center text-muted">Sin productos ingresados en el Carrito</h5>
                            <?php endif; ?>
                            ...
                            <?php if ($gt > 0) : ?>
                                <div class="py-1 text-center">
                                    <a href="./?p=checkout" class="btn btn-lg btn-deafault text-light bg-gradient-maroon col-lg-4 col-md-6 col-sm-12 col-xs-12 rounded-pill">Ordenar</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<script>
    ...
    $(function() {
        ...
        $('.del-item').click(function() {
            var item = $(this).closest('.cart-item')
            var id = item.attr('data-id')
            _conf("¿Deseas eliminar este producto de tu carrito?", "delete_cart", [id])
        })
    })
